    ...
    <header className="header">
      <div className="header-left">
        ...
        <div className="header-brand">
          <span className="header-title">AI Evaluator</span>
          <span className="header-subtitle">AI-powered Assignment Evaluation</span>
        </div>
      </div>

      <div className="header-right">
        <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="header-icon-btn" aria-label="GitHub">
        ...
        <div className="header-dark-mode-badge">
          <span className="header-dark-dot" />
          Dark Mode
        </div>
      </div>
    </header>
