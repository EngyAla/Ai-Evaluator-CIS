...
import { t as require_browser_external_fs } from "./browser-external_fs-BNgma0vv.js";
//#region ../Backend/node_modules/ms/index.js
...
//#endregion
//#region ../Backend/node_modules/debug/src/common.js
...
//#endregion
//#region ../Backend/node_modules/debug/src/browser.js
...
//#endregion
//#region ../Backend/node_modules/@kwsites/file-exists/dist/src/index.js
var require_src = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var log = __importDefault(require_browser()).default("@kwsites/file-exists");
...
//#endregion
//#region ../Backend/node_modules/@simple-git/args-pathspec/dist/index.mjs
...
//#endregion
//#region ../Backend/node_modules/@kwsites/promise-deferred/dist/index.js
...
//#endregion
//#region ../Backend/node_modules/@simple-git/argv-parser/dist/index.mjs
var import_browser = /* @__PURE__ */ __toESM(require_browser(), 1);
var import_browser_external_child_process = require_browser_external_child_process();
...
//#endregion
//#region ../Backend/node_modules/simple-git/dist/esm/index.js
var import_browser_external_node_events = (/* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
...
function createLog() {
	return (0, import_browser.default)("simple-git");
}
...
var init_git_logger = __esm({ "src/lib/git-logger.ts"() {
	"use strict";
	init_utils();
	import_browser.default.formatters.L = (value) => String(filterHasLength(value) ? value.length : "-");
	import_browser.default.formatters.B = (value) => {
	...
	GitExecutorChain = class {
		...
		async gitResponse(task, command, args, outputHandler, logger) {
			...
			return new Promise((done) => {
				...
				const spawned = (0, import_browser_external_child_process.spawn)(command, args, spawnOptions);
...
function toPath(input) {
	...
	return path && (0, import_browser_external_node_path.normalize)(path);
}
...
var PluginStore = class {
	constructor() {
		...
		this.events = new import_browser_external_node_events.EventEmitter();
	}
	on(type, listener) {
...
function gitP(...args) {
	...
	const promiseApi = [...functionNamesBuilderApi, ...functionNamesPromiseApi].reduce((api, name) => {
		...
		Object.defineProperty(api, name, {
			enumerable: false,
			configurable: false,
			value: git ? valid : isAsync ? chainReturn : builderReturn
		});
		return api;
	}, {});
	return promiseApi;
	function asyncWrapper(fn, git2) {
		return function(...args2) {
			if (typeof args2[args2.length] === "function") throw new TypeError("Promise interface requires that handlers are not supplied inline, trailing function not allowed in call to " + fn);
...
//#endregion
export { CheckRepoActions, CleanOptions, DiffNameStatus, GitConfigScope, GitConstructError, GitError, GitPluginError, GitResponseError, ResetMode, TaskConfigurationError, esm_default as default, gitP, grepQueryBuilder, c as pathspec, simpleGit };
